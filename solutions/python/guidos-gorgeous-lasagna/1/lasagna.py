...
def preparation_time_in_minutes(layers):
    ...
    Function that takes the layers in the lasagna and returns how many minutes of
    preparation time are needed based on the `PREPARATION_TIME`.
    """
...
def elapsed_time_in_minutes(number_of_layers, elapsed_bake_time):
    ...
    your preparation time layering + the time the lasagna has spent baking in
    the oven.
    """
